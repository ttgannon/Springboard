...
function showFirstAndLast(arr){
    ...
    arr.forEach(function (char) {
            newString.push(char[0] + char[char.length-1]);
    })
    return newString;
}
...
vowel and the values as the number of times the vowel appears in the string. 
...
which accepts an array and returns a new array with all of the odd numbers doubled 
