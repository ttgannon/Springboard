...
class StoryList {
  ...
  async addStory(user, { storyTitle, storyAuthor, storyUrl }) {
    console.log(storyTitle, storyAuthor, storyUrl);
    ...
    let response = await axios({
      ...
      data: { 
        token, 
        story: {title: storyTitle, author: storyAuthor, url: `http://www.${storyUrl}`} 
      },
    });
